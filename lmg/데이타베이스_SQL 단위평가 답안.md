...
![ex_screenshot](./resource/1-1.png)
![ex_screenshot](./resource/1-2.png)
![ex_screenshot](./resource/1-3.png)
![ex_screenshot](./resource/1-4.png)
...
![ex_screenshot](./resource/2-1.png)
...
![ex_screenshot](./resource/3-1.png)
![ex_screenshot](./resource/3-11.png)
2. 주문 ID가 1인 주문에서 특정 제품(예: 제품 ID 2)을 삭제하는 SQL DELETE 문을 작성하세요. (10점)

![ex_screenshot](./resource/3-2.png)
![ex_screenshot](./resource/3-22.png)
